...
public class MailUtils {
        ...
        return Session.getInstance(prop,
                new Authenticator() {
                    protected PasswordAuthentication getPasswordAuthentication() {
                        return new PasswordAuthentication(Constanc.EMAIL_ACC, Constanc.EMAIL_PWD);
                    }
                });
    }
    ...
    private static Message prepareMessage(String to, String subject) throws MessagingException {
        ...
        message.setFrom(new InternetAddress(Constanc.EMAIL_ACC));
    ...
    public static void main(String[] args) {
        ...
        send("nazaruktatiana@rambler.ru", "TEST", "TEST");
